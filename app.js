// ==== Chapter-1 & Task-1
//alert("Welcome from Saylani Mass Training");
...
// ==== Chapter-2 & Task-4
/*var studentName = "Wasim Iqbal";
var studentAge = "35 years old";
var studentsubject = "Certified Mobile Application Development";
alert(studentName);
alert(studentAge);
alert(studentsubject);*/
...
// ==== Chapter-2 & Task-8
//document.write("I can write content through JavaScript")
...
// ==== Chapter-4 & Task-3
/*var b =("Variablenamescanonlycontain______,______,______and______.Forexample$my_1stVariable");
...
var b = 5;
var c = b * a;
document.write("Multiplication of " + b + " with " + a + " is " + c);*/

/*var a = 3;
var b = 5;
var c = b / a;
document.write("Divide " + b + " from " + a + " is " + c);*/
...
// ==== Chapter-5 & Task-6
/*var celTemp = 25;
var cnvtFarnht = (celTemp * 9 / 5) + 32;
document.write(celTemp + " <sup>oC</sup> is " + cnvtFarnht + " <sup>oF</sup>" + " <br> ");
...
// ==== Chapter-9-11 & Task-3
/*var a = prompt("Road Traffic Signal", "Red/Yellow or Green");
if (a === "Red") {
    alert("Must Stop")
} else if (a === "Yellow") {
    alert("Ready to move")
